...
#ifndef PCC_SLEEPSTUDY_WIDGET_H_
#define PCC_SLEEPSTUDY_WIDGET_H_
#include <fstream>
#include <iostream>
...
class PccSleepStudyWidget : public Wt::WContainerWidget
{
public:
    PccSleepStudyWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
