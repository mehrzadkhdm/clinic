...
#ifndef MARKETING_PHYSICIANISSUE_WIDGET_H_
#define MARKETING_PHYSICIANISSUE_WIDGET_H_
#include <fstream>
#include <iostream>
...
class MarketingPhysicianIssueWidget : public Wt::WContainerWidget
{
public:
    MarketingPhysicianIssueWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
#endif //MARKETING_PHYSICIANVISSUE_WIDGET_H
