...
#ifndef MARKETING_PHYSICIAN_REPORT_WIDGET_H_
#define MARKETING_PHYSICIAN_REPORT_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class MarketingPhysicianReportWidget : public Wt::WContainerWidget
{
public:
    MarketingPhysicianReportWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
private:
    ...
    PccPhysicianReportWidget *physicianReport;
...
private:
    ...
    void newReferral();
    void showResult(Wt::WDate& startDate, Wt::WDate& endDate, Wt::WString& pcc);
};

#endif //MARKETING_PHYSICIAN_REPORT_WIDGET_H_
