...
StaffLoginTemplate::StaffLoginTemplate(UserSession *session, WContainerWidget *parent = 0)
    : WTemplate(parent),
    session_(session)
{
    init();
