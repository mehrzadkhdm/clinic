...
#ifndef PCC_REFERRAL_WIDGET_H_
#define PCC_REFERRAL_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class PccReferralWidget : public Wt::WContainerWidget
{
public:
    PccReferralWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
