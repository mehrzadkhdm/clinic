...
#ifndef ADMIN_INSURANCE_WIDGET_H_
#define ADMIN_INSURANCE_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class AdminInsuranceWidget : public Wt::WContainerWidget
{
public:
	AdminInsuranceWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
private:
	...
	InsuranceResultWidget *referralResult;
...
#endif //ADMIN_INSURANCE_WIDGET_H
