...
#ifndef MARKETING_REFERRAL_WIDGET_H_
#define MARKETING_REFERRAL_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class MarketingReferralWidget : public Wt::WContainerWidget
{
public:
    MarketingReferralWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
private:
    ...
    ReferralResultWidget *referralResult;
...
private:
    ...
    void newReferral();
    void showResult(Wt::WDate& startDate, Wt::WDate& endDate, Wt::WString& status);
};

#endif //MARKETING_REFERRAL_WIDGET_H
