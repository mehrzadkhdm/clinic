...
#ifndef CALENDAR_CONTAINER_WIDGET
#define CALENDAR_CONTAINER_WIDGET
...
class CalendarContainerWidget : public Wt::WContainerWidget
{
public:
    CalendarContainerWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
    ...
    void showCalendar(Wt::WString &location, Wt::WDate &calendarDate);
...
private:
    ...
    Calendar *calendar;
    Wt::WContainerWidget *calendarOutside;

    void showStudyDialog(Wt::WString std);
};

#endif //CALENDAR_CONTAINER_WIDGET
