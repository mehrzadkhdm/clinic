...
#ifndef MARKETING_VISIT_REPORT_WIDGET_H_
#define MARKETING_VISIT_REPORT_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class MarketingVisitReportWidget : public Wt::WContainerWidget
{
public:
    MarketingVisitReportWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
private:
    ...
    PccVisitReportWidget *visitReport;
...
#endif //MARKETING_VISIT_REPORT_WIDGET_H
