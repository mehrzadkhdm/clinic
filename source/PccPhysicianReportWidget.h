...
#ifndef PCC_PHYSICIAN_REPORT_WIDGET_H_
#define PCC_PHYSICIAN_REPORT_WIDGET_H_
...
class PccPhysicianReportWidget : public Wt::WContainerWidget
{

public:
    PccPhysicianReportWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
public:
    ...
    void showPhysicianReport(Wt::WDate& startDate, Wt::WDate& endDate, Wt::WString& pcc);
...
#endif //PCC_PHYSICIAN_REPORT_WIDGET_H
