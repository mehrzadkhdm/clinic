...
#ifndef ADMIN_REFERRAL_WIDGET_H_
#define ADMIN_REFERRAL_WIDGET_H_
#include <fstream>
#include <iostream>
...
class UserSession;
class AdminReferralWidget : public Wt::WContainerWidget
{
public:
    AdminReferralWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
