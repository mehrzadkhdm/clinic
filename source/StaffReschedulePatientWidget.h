...
#ifndef STAFF_RESCHEDULE_PATIENT_WIDGET_H_
#define STAFF_RESCHEDULE_PATIENT_WIDGET_H_
...
class StaffReschedulePatientWidget : public Wt::WContainerWidget
{
public:
    StaffReschedulePatientWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
#endif //STAFF_RESCHEDULE_PATIENT_WIDGET_H
