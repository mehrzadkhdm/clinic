...
#ifndef PHYSICIAN_REGISTRATION_MODEL_H_
#define PHYSICIAN_REGISTRATION_MODEL_H_
 ...
 * \ingroup auth
 */
class PhysicianRegistrationModel : public FormBaseModel
{
public:
  ...
  enum EmailPolicy {
    ...
    EmailOptional,  //!< A user may optionally provide an email address
   ...
   */
    PhysicianRegistrationModel(const Wt::Auth::AuthService& baseAuth,
             Wt::Auth::AbstractUserDatabase& practices,
             Wt::Auth::Login& login,
             Wt::Auth::User& practice,
             Wt::WObject *parent = 0);

 /* Returns the valuetext of the email field to the view */
  Wt::WString inputEmail() {
    return valueText(EmailField);
  }
...
#endif // PHYSICIAN_REGISTRATION_MODEL_H_
