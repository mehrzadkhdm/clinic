...
#ifndef SLEEPSTUDY_LIST_CONTAINER_WIDGET
#define SLEEPSTUDY_LIST_CONTAINER_WIDGET
...
class SleepStudyListContainerWidget : public Wt::WContainerWidget
{
public:
    SleepStudyListContainerWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
#endif //SLEEPSTUDY_LIST_CONTAINER_WIDGET
