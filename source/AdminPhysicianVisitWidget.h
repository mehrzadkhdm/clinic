...
#ifndef ADMIN_PHYSICIANVISIT_WIDGET_H_
#define ADMIN_PHYSICIANVISIT_WIDGET_H_
#include <fstream>
#include <iostream>
...
class AdminPhysicianVisitWidget : public Wt::WContainerWidget
{
public:
	AdminPhysicianVisitWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
#endif //ADMIN_PHYSICIANVISIT_WIDGET_H
