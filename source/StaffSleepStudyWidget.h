...
#ifndef STAFF_SLEEPSTUDY_WIDGET_H_
#define STAFF_SLEEPSTUDY_WIDGET_H_
#include <fstream>
#include <iostream>
...
class StaffSleepStudyWidget : public Wt::WContainerWidget
{
public:
    StaffSleepStudyWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
...
private:
    ...
    SleepStudyListContainerWidget *stContainer;
    Wt::WStackedWidget *resultStack_;
    Wt::WContainerWidget *ptResultStack_;
...
#endif //STAFF_SLEEPSTUDY_WIDGET_H
