...
MarketingReferralWidget::MarketingReferralWidget(const char *conninfo, UserSession *session, WContainerWidget *parent) :
...
void MarketingReferralWidget::searchList()
{
    ...
    Wt::WText *delabel = new Wt::WText("Please select the date range for the studies report.");
    ...
    cb->addItem("All");
    cb->addItem("Scheduled");
    cb->addItem("Unscheduled");
    ...
    button->clicked().connect(std::bind([=] () {
        ...
        MarketingReferralWidget::showResult(start, end, status);
    }));
...
void MarketingReferralWidget::showResult(Wt::WDate& startDate, Wt::WDate& endDate, Wt::WString& status)
{
