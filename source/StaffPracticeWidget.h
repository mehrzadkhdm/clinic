...
#ifndef STAFF_PRACTICE_WIDGET_H_
#define STAFF_PRACTICE_WIDGET_H_
#include <fstream>
#include <iostream>
...
class StaffPracticeWidget : public Wt::WContainerWidget
{
public:
    StaffPracticeWidget(const char *conninfo, UserSession *session, Wt::WContainerWidget *parent = 0);
